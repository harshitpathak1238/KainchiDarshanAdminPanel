...
function navigate(route) {
  ...
  document.body.classList.remove('blog-editor-active');
...
async function blogForm(id = '') {
  const content = document.querySelector('#content');
  document.body.classList.add('blog-editor-active');
  ...
  if (id) {
    try {
      ...
      document.querySelector('#blog-page-title').textContent = post.title || 'Edit post';
